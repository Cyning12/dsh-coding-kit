...
| **W2** | L0+L2：`00_main` + 4 条 `10_flow_*` 的 `.graph.yaml` 构图 · compile/export/check 绿 · 拟发版 **1.9.x**（本波不 bump）· task [`docs/tasks/active/task_self_tech_graph_w2_yaml.md`](../../tasks/active/task_self_tech_graph_w2_yaml.md) | W1 | — |
