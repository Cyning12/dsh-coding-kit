...
| **W3** | CI `tech-graph.yml` 入仓 · `02_version.md` 首版 · 获批迁移项执行（reference/ + POINTERS + 死链 grep）· 拟发版 **1.9.x**（本波不 bump）· task [`docs/tasks/active/task_self_tech_graph_w3_ci_migrate.md`](../../tasks/active/task_self_tech_graph_w3_ci_migrate.md) | W2 | — |
