...
| 波 | 内容 | 依赖 | 人闸 |
|----|------|------|------|
| **W0** | 盘点复核：三树 diff（重点 ledger vs 01_defects 去重清单）· 迁/留判定定稿 | SPEC 签收 | HG-SPEC-SIGNOFF |
| **W1** | L1：`01_struct.md` 模块边界表（按 1.8.0 src/ 实读重核 · 参考 00_inventory 不照抄） | W0 | **HG-GRAPH-MODULES** |
