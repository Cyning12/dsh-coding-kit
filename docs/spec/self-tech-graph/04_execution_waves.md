...
| **W1** | L1：`01_struct.md` 模块边界表（按 1.9.0 src/ 实读重核 · 参考 00_inventory 不照抄）· **伴生**：W0 人裁执行（ledger 补录 DEF-028~033 · R-05/M-3 关 pending）· task [`docs/tasks/active/task_self_tech_graph_w1_struct.md`](../../tasks/active/task_self_tech_graph_w1_struct.md) | W0 | **HG-GRAPH-MODULES**（01_struct 落盘后签 · **不挡本波 30**） |
