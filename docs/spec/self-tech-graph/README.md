...
> **人闸**：`HG-SPEC-SIGNOFF` = **approved**（2026-08-27 · 00 代签）· `HG-GRAPH-MODULES` = pending（W1 交付 `01_struct.md` 后签 · **不挡 W1 30**）  
...
| HG-GRAPH-MODULES | pending | 30（**W2 构图/改码**） | W1 写 `docs/_tech_graph/01_struct.md` 后由 00 代签；**不挡本波文档 30** |
