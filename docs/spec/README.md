...
| `self-tech-graph` | [`self-tech-graph/`](./self-tech-graph/) | **signed** · W2 yaml 已落盘 [`../_tech_graph/`](../_tech_graph/) · **W3** 进行中 · 拟发版 **1.9.x** | kit 自身三层技术图谱 + 外置三树迁留 · 读序见 [`self-tech-graph/README.md`](./self-tech-graph/README.md) |
