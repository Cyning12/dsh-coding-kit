...
| `self-tech-graph` | [`self-tech-graph/`](./self-tech-graph/) | **signed** · HG-GRAPH-MODULES=approved · W1 L1 [`../_tech_graph/01_struct.md`](../_tech_graph/01_struct.md) · 拟发版 **1.9.x** · W2 进行中 | kit 自身三层技术图谱 + 外置三树迁留 · 读序见 [`self-tech-graph/README.md`](./self-tech-graph/README.md) |
